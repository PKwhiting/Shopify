...
class BaseResource(ABC):
    ...
    def _execute_query_with_validation(self, query: str, variables: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
    ...
    def _execute_mutation_with_validation(self, mutation: str, variables: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
    ...
    def _validate_id(self, resource_id: str) -> str:
        ...
        if not resource_id or not isinstance(resource_id, str):
            raise ValueError(f"{self.get_resource_name().capitalize()} ID must be a non-empty string")
        
        resource_id = resource_id.strip()
        if not resource_id:
            raise ValueError(f"{self.get_resource_name().capitalize()} ID cannot be empty or whitespace")
